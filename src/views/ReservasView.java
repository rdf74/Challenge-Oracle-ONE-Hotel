...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblValorSimbolo.setBounds(89, 332, 239, 25);
		...
		lblCheckOut.setFont(new Font("Dialog", Font.PLAIN, 16));
		...
		//activa el evento, despues del usuario seleccionar las fechas se debe calcular el valor de la reserva
			}
		});
